...
export const VehicleCard = ({ vehicle }: VehicleCardProps) => (
  <motion.article
    className="flex h-full min-h-[474px] flex-col overflow-hidden rounded-lg border border-blue-950/10 bg-white shadow-sm shadow-blue-950/5 transition hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-950/10"
